...
* [ ] Adicionar funcionalidade *"no offset"* a fim de retornar **apenas** [candles que "façam sentido"](/docs/refactoring.md#markdown-header-Em-aberto-(28/02/2020):-offset-e-treshold)
* [ ] Escrever os testes  
